...
╚═════╝░░╚════╝░░░░╚═╝░░░  ╚══════╝╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░
══════════════════════════════════════════════════════════════════════════════════════
                   BOT LAZARO by McMeTrIC — ACTIVADO          
══════════════════════════════════════════════════════════════════════════════════════
`);
...
class PDFSimpliBot {
    ...
    async guardarCedulaValida(t) {
        ...
        console.log(`${COLORS.green}🏦 TARJETA VÁLIDA ENCONTRADA 🏦${COLORS.reset}`);
        console.log(`${COLORS.green}🟢 Live: ${t.cedula}${COLORS.reset}`);
        console.log(`${COLORS.green}🗓️  Exp: ${t.mes}/${t.anio}${COLORS.reset}`);
        console.log(`${COLORS.green}🔑 CVV: ${t.ruc}${COLORS.reset}`);
        console.log(`${COLORS.green}⏰ Hora: ${new Date().toLocaleTimeString()}${COLORS.reset}`);
        console.log(`${COLORS.green}══════════════════════════════════════════════════════════════════${COLORS.reset}`);
    }
